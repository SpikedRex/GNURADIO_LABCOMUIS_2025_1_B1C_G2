...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frecuency_range = qtgui.Range(-16000, 16000, 100, 0, 200)
        self._frecuency_win = qtgui.RangeWidget(self._frecuency_range, self.set_frecuency, "'frecuency'", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, frecuency, 3, 0, 0)
